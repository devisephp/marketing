...
<div class="relative flex justify-center p-4">
  <div class="container mt-8 mb-8 md:mb-12 w-full md:w-4/5 flex flex-col items-start" :class="[devise.leftOrRight.value]">
    <div class="w-full md:w-1/2 px-8 md:px-10" :style="{color: devise.copyColor.color}">
      <h2>
    ...
    <div class="w-full md:w-1/2 relative text-center flex flex-wrap">
      <slices :slices="slices" class="w-full md:w-1/2 p-4"></slices>
    </div>
  </div>
</div>
@endsection
